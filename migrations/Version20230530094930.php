 ...
 */
final class Version20230530094930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post RENAME COLUMN user_id_id TO author_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post RENAME COLUMN author_id TO user_id_id');
